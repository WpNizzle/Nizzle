...
function Product({ name, price, rating, sales, image, category, detailsLink, liveDemoLink }) {
  return (
    <div className="bg-white rounded-lg shadow-lg p-4">
      ...
      <div className="text-center">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <a
            href={liveDemoLink}
            className="bg-gray-500 text-white rounded-lg px-4 py-2 mt-4 hover:bg-gray-600"
          >
            Live Demo
          </a>
        </div>

        <button className="bg-green-500 text-white rounded-lg px-4 py-2 mt-4 hover:bg-green-600">
          Add to Cart
        </button>
      </div>
    </div>
